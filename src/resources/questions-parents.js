...
const questions = [
  ...
  { id: 5,   fields: ["LP"],                options: [0, 1] },
  { id: 6,   fields: ["CD"],                options: [0, 1, 2, 3] },
  { id: 7,   fields: ["LP"],                options: [0, 1, 2, 3] },
  { id: 8,   fields: ["NI"],                options: [0, 1, 2, 3] },
  { id: 9,   fields: ["LP"],                options: [0, 1, 2, 3] },
  ...
  { id: 18,  fields: ["NI"],                options: [0, 1, 2, 3] },
  ...
  { id: 26,  fields: ["NI"],                options: [0, 1, 2, 3] },
  ...
  { id: 31,  fields: ["PI"],                options: [0, 1, 2, 3] },
  { id: 32,  fields: ["NI"],                options: [0, 1, 2, 3] },
  { id: 33,  fields: ["PI"],                options: [0, 1, 2, 3] },
  { id: 34,  fields: ["EF", "GL"],          options: [0, 1, 2, 3] },
  { id: 35,  fields: ["AN"],                options: [0, 1, 2, 3] },
  { id: 36,  fields: ["LP"],                options: [0, 1, 2, 3] },
  { id: 37,  fields: ["EF"],                options: [0, 1, 2, 3] },
  { id: 38,  fields: ["PI"],                options: [0, 1, 2, 3] },
  { id: 39,  fields: ["AG", "CD"],          options: [0, 1, 2, 3] },
  { id: 40,  fields: ["GL"],                options: [0, 1, 2, 3] },
